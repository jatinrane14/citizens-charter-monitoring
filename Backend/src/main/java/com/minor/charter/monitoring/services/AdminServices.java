...
public class AdminServices extends UserServicesImplementation{
    ...
    public ResponseEntity<AuthResponse> verify(AdminModel user) {
        String token=null;
        ...
        try{
            ...
            if(authentication.isAuthenticated()) {
                dbUser = adminRepo.findByUserEmail(user.getUserEmail());
    ...
    public ResponseEntity<AdminModel> createAdmin(AdminModel admin){
